...
public class MapDisplayView extends View{
    ...
    public boolean doAction(String choice) {
        ...
        switch (choice){
            ...
            try {
                ...
                Logger.getLogger(MapDisplayView.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
                 break;
            default:
    ...
    private void moveActorLocation() throws MapControlException {
        Point coordinates = null;
        //move actor to specified location
        //int returnValue = MapControl.moveActorsToLocation(actor, coordinates);
        MapControl.moveActorsToLocation(Actor.Elf, coordinates);
    }
